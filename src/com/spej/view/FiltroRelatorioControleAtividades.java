 ...
 * @author Daniel
 */
public class FiltroRelatorioControleAtividades extends javax.swing.JDialog {

    /**
     * Creates new form FiltroRelatorioControleAtividades
     */
    public FiltroRelatorioControleAtividades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório de Controle de Atividades");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FiltroRelatorioControleAtividades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FiltroRelatorioControleAtividades dialog = new FiltroRelatorioControleAtividades(new javax.swing.JFrame(), true);
